...
public class LogicalAptiSection extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.logical_aptitude_activity);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (count < totalQns - 1) {
                    ...
                    Intent i4 = new Intent(getApplicationContext(), TechnicalAptiSection.class);
                    i4.putExtra("userName", userName);
                    i4.putExtra("scoreCard", score);
                    startActivity(i4);
//                    Toast.makeText(getApplicationContext(), userName + "'s Score: " + score, Toast.LENGTH_SHORT).show();
                }
            }
